...
class CE_Map_Widget extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control('markers', ['type' => Controls_Manager::REPEATER, 'fields' => $repeater->get_controls(), 'default' => [['lat' => '42.6977', 'lng' => '23.3219', 'title' => 'София', 'content' => 'Примерен popup', 'icon' => ['url' => '']]], 'title_field' => '{{{ title }}}']);
        $this->end_controls_section();
    }
